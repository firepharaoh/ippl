#ifndef IPPL_ALVINE_FIELDS_FIELDCONTAINER3D_HPP
#define IPPL_ALVINE_FIELDS_FIELDCONTAINER3D_HPP
...
template <typename T>
class FieldContainer3D {
public:
    static constexpr unsigned Dim = 3;

    using vorticity_field_type = VField_t<T, Dim>;

    FieldContainer3D(Vector_t<T, Dim>& hr, Vector_t<T, Dim>& rmin,
