#ifndef IPPL_ALVINE_CORE_ALVINE_MANAGER2D_H
#define IPPL_ALVINE_CORE_ALVINE_MANAGER2D_H
...
template <typename T>
class AlvineManager2D
    : public ippl::PicManager<T, 2, ParticleContainer<T, 2>, FieldContainer<T, 2>,
                              LoadBalancer<T, 2>> {
public:
